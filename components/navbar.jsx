    ...
    return(
        <div className="bg-white sticky top-0 flex justify-between items-center px-44 py-2 z-10">
            ...
            <ul className="flex justify-between items-center gap-16">
                ...
                <Link to='products' className="font-sans text-black-500 text-xl font-bold hover:text-red-500 cursor-pointer">Product</Link>
                <Link to='cart' className="font-sans text-black-500 text-xl font-bold hover:text-red-500 cursor-pointer">Cart</Link>
            </ul>
            <button className="bg-black font-bold border-2 border-white text-xl p-3 text-white rounded-xl hover:text-black hover:bg-white hover:border-black">Sign up</button>
        </div>
    )
}
